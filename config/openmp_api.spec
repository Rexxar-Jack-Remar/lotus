...
__kmpc_end_single TD_OMP_SINGLE_END library=openmp semantic=single-end traits=omp-task-op
...
__kmpc_for_static_fini TD_OMP_FOR_STATIC_FINI library=openmp semantic=for-static-fini traits=omp-task-op
...
__kmpc_end_sections TD_OMP_SECTIONS_END library=openmp semantic=sections-end traits=omp-task-op
...
__kmpc_cancel_barrier TD_BAR_WAIT library=openmp semantic=cancel-barrier traits=omp-task-op,barrier-wait-like
...
__kmpc_dispatch_fini TD_OMP_FOR_DISPATCH_FINI library=openmp semantic=dispatch-fini traits=omp-task-op match=prefix
