...
CCFG::Node *lotus::lif::transform::CCFG::Node::make(
...
CCFG::ChildrenTy lotus::lif::transform::CCFG::Node::successors(
...
std::vector<CCFG::Node *> lotus::lif::transform::CCFG::postOrder(
...
std::vector<CCFG::Node *> lotus::lif::transform::CCFG::compactOrder(
