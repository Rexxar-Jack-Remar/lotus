...
class GA:
    ...
    def repopulate(self) -> bool:
        """
        If it loops infinitely, return false.
        Else return True.
        """
        ...
        while len(self._population) < self._population_size:
            ...
            if all(self._new[i].fitness == 4294967295 for i in range(len(self._new))):
                return False
            if i1 == i2: continue
            ...
            # FIXME: 处理可能的极少数 _new[xx].fitness 全为 4294967295 的无限循环
        self._new = []
        return True
