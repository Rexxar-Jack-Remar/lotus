...
SuppressionManager::Span SuppressionManager::parseSpan(const std::string& jsonValue) {
    Span span;
...
llvm::StringSet<> SuppressionManager::getSuppressedTypes(const std::string& filename) const {
...
bool SuppressionManager::parseSuppressionComment(const std::string& comment,
