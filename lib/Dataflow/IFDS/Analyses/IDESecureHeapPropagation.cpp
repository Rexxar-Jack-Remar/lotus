...
IDESecureHeapPropagation::FactSet IDESecureHeapPropagation::call_to_return_flow(
...
IDESecureHeapPropagation::EdgeFunction
IDESecureHeapPropagation::return_edge_function(
...
IDESecureHeapPropagation::EdgeFunction
IDESecureHeapPropagation::summary_edge_function(
    const llvm::CallBase *call, const llvm::Function *callee,
