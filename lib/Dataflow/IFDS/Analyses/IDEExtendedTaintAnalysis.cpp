...
IDEExtendedTaintAnalysis::FactSet IDEExtendedTaintAnalysis::call_to_return_flow(
...
IDEExtendedTaintAnalysis::EdgeFunction
IDEExtendedTaintAnalysis::return_edge_function(
...
IDEExtendedTaintAnalysis::EdgeFunction
IDEExtendedTaintAnalysis::summary_edge_function(
    const llvm::CallBase *call, const llvm::Function *callee,
