...
std::optional<long long> IDEConstantPropagation::asConst(const llvm::Value *v) {
...
IDEConstantPropagation::FactSet IDEConstantPropagation::call_to_return_flow(
...
IDEConstantPropagation::EdgeFunction
IDEConstantPropagation::return_edge_function(
    const llvm::CallBase *call, const llvm::Function *callee,
...
IDEConstantPropagation::EdgeFunction
IDEConstantPropagation::call_to_return_edge_function(
    const llvm::CallBase *call, const llvm::Instruction *return_site,
...
IDEConstantPropagation::EdgeFunction
IDEConstantPropagation::summary_edge_function(
    const llvm::CallBase *call, const llvm::Function *callee,
