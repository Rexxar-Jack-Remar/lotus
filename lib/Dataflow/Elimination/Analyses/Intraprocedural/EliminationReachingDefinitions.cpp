...
public:
  explicit ElimReachingDefinitionsProblem(llvm::Function *F,
      ...
      : LLVMIntraEliminationProblem<ReachingDefinitionsFact>(F),
        AA(AA), MSSA(MSSA) {}

  ReachingDefinitionsFact applyTransfer(const transfer_t &T,
  ...
  ReachingDefinitionsFact meet(const ReachingDefinitionsFact &Lhs,
