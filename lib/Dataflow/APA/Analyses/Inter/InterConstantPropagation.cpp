...
struct InterConstantPropagationDomain {
...
class InterElimConstantPropagationProblem
    : public LLVMInterEliminationProblem<InterConstantPropagationDomain> {
public:
  explicit InterElimConstantPropagationProblem(
      ...
      : LLVMInterEliminationProblem<InterConstantPropagationDomain>(
