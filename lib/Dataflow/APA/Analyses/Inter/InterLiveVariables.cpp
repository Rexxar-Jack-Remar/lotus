...
struct InterLiveVariablesDomain {
...
class InterElimLiveVariablesProblem
    : public LLVMInterEliminationProblem<InterLiveVariablesDomain> {
public:
  explicit InterElimLiveVariablesProblem(
      llvm::Function *Entry, const dataflow::controlflow::InterCFG *ICF)
      : LLVMInterEliminationProblem<InterLiveVariablesDomain>(
...
InterLiveVariablesResult runInterElimLiveVariables(
  ...
  InterEliminationSolver<InterLiveVariablesDomain,
