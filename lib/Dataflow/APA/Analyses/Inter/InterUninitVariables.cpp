...
struct InterUninitVariablesDomain {
...
class InterElimUninitVariablesProblem
    : public LLVMInterEliminationProblem<InterUninitVariablesDomain> {
public:
  explicit InterElimUninitVariablesProblem(
      ...
      : LLVMInterEliminationProblem<InterUninitVariablesDomain>(
...
runInterElimUninitVariables(llvm::Function *Entry, llvm::AAResults *AA,
  ...
  InterEliminationSolver<InterUninitVariablesDomain,
