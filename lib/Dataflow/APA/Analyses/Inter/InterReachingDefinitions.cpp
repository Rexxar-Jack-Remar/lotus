...
struct InterReachingDefinitionsDomain {
...
class InterElimReachingDefinitionsProblem
    : public LLVMInterEliminationProblem<InterReachingDefinitionsDomain> {
public:
  explicit InterElimReachingDefinitionsProblem(
      ...
      : LLVMInterEliminationProblem<InterReachingDefinitionsDomain>(
  ...
  fact_t allTop() const override { return fact_t{}; }
...
runInterElimReachingDefinitions(llvm::Function *Entry, llvm::AAResults *AA,
  ...
  InterEliminationSolver<InterReachingDefinitionsDomain,
