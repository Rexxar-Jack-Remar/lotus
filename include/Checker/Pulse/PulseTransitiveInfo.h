...
public:
    ...
    struct CallInfo {
        ...
        CallInfo(const llvm::Instruction* cs, const llvm::Function* c, CallResolution r)
...
public:
     ...
     */
    void recordTransitiveAccess(const llvm::Instruction* loc, const llvm::Function* func) {
     ...
     */
    void recordCallResolution(const llvm::Instruction* call_site,
                            const llvm::Function* caller,
                            CallResolution resolution,
    ...
    const std::vector<AccessInfo>& getTransitiveAccesses() const { return transitive_accesses_; }
    const std::vector<CallInfo>& getCallResolutions() const { return call_resolutions_; }
     ...
     */
    static TransitiveInfo merge(const TransitiveInfo& t1, const TransitiveInfo& t2);
};
