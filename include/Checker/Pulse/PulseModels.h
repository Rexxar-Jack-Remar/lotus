...
struct ModelResult {
    ...
    static ModelResult success(std::vector<ExecutionDomain> s) { return {true, std::move(s)}; }
};
...
public:
     ...
     */
    ModelResult dispatch(const llvm::CallInst* call, 
                         ExecutionDomain& state,
                         const llvm::BasicBlock* pred);
...
private:
    ...
    ModelResult modelMalloc(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelCalloc(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelFree(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelRealloc(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelFileOpen(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelFileClose(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelLock(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelUnlock(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelStringCopy(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelStrdup(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ...
    ModelResult modelFread(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelFwrite(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelFgets(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelGets(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    
    // C++ Models
    ModelResult modelStdVectorPushBack(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelStdVectorAccess(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelStdVectorData(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelStdStringCStr(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    
    // std::unique_ptr
    ModelResult modelStdUniquePtrRelease(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelStdUniquePtrReset(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelStdUniquePtrGet(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ModelResult modelStdUniquePtrDtor(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred);
    ...
    ModelResult modelTaintSink(const llvm::CallInst* call, ExecutionDomain& state, const llvm::BasicBlock* pred, const std::string& kind);
};
