...
public:
    ...
    static void logInstruction(const llvm::Instruction* I, const std::string& action);
    static void logBug(OperationResult kind, const llvm::Instruction* loc, const std::string& details = "");
