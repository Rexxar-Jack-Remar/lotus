...
/**
 * PulseFormula: tracks path conditions including equalities, constraints, and linear arithmetic.
 * Enhanced with basic linear arithmetic reasoning following Infer's design.
 */
class PulseFormula {
private:
...
public:
     ...
     */
    bool addBitwiseAnd(AbstractValue result, AbstractValue op1, AbstractValue op2);
     ...
     */
    bool addBitwiseXor(AbstractValue result, AbstractValue op1, AbstractValue op2);
     ...
     */
    bool addRightShift(AbstractValue result, AbstractValue op1, AbstractValue op2);
