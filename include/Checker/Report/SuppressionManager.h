...
public:
     ...
     */
    void addSuppression(const std::string& issueType, 
     ...
     */
    bool isSuppressed(const std::string& issueType,
                     const std::string& filename,
                     int line) const;
     ...
     */
    static bool parseSuppressionComment(const std::string& comment,
