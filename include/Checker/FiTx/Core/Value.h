/// \file Value.hpp
/// FiTx value representation: field-sensitive (static field offsets only).
/// Paper: Suzuki et al., USENIX ATC 2024, Section 3 (FiT analysis: struct
/// fields or constant array indices; no runtime field offset calculation).
#pragma once
#include <map>
#include <queue>
#include <set>
