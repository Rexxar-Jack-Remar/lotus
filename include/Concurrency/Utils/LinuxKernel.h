...
inline bool isSpinLockInit(const llvm::StringRef &funcName) {
  return funcName.equals("spin_lock_init") ||
         funcName.equals("raw_spin_lock_init");
}

inline bool isSpinLock(const llvm::StringRef &funcName) {
  return funcName.equals("spin_lock") || funcName.equals("raw_spin_lock") ||
         funcName.equals("_raw_spin_lock") ||
         funcName.equals("spin_lock_irq") ||
         funcName.equals("raw_spin_lock_irq") ||
         funcName.equals("_raw_spin_lock_irq") ||
         funcName.equals("spin_lock_irqsave") ||
         funcName.equals("raw_spin_lock_irqsave") ||
         funcName.equals("_raw_spin_lock_irqsave") ||
         funcName.equals("spin_lock_bh") ||
         funcName.equals("raw_spin_lock_bh") ||
         funcName.equals("spin_lock_nested") ||
         funcName.equals("raw_spin_lock_nested") ||
         funcName.equals("_raw_spin_lock_nested") ||
         funcName.equals("spin_lock_nest_lock") ||
         funcName.equals("raw_spin_lock_nest_lock") ||
         funcName.equals("_raw_spin_lock_nest_lock");
}

inline bool isSpinUnlock(const llvm::StringRef &funcName) {
  return funcName.equals("spin_unlock") || funcName.equals("raw_spin_unlock") ||
         funcName.equals("_raw_spin_unlock") ||
         funcName.equals("spin_unlock_irq") ||
         funcName.equals("raw_spin_unlock_irq") ||
         funcName.equals("_raw_spin_unlock_irq") ||
         funcName.equals("spin_unlock_irqrestore") ||
         funcName.equals("raw_spin_unlock_irqrestore") ||
         funcName.equals("_raw_spin_unlock_irqrestore") ||
         funcName.equals("spin_unlock_bh") ||
         funcName.equals("raw_spin_unlock_bh");
}

inline bool isSpinTryLock(const llvm::StringRef &funcName) {
  return funcName.equals("spin_trylock") ||
         funcName.equals("raw_spin_trylock") ||
         funcName.equals("_raw_spin_trylock") ||
         funcName.equals("spin_trylock_bh") ||
         funcName.equals("raw_spin_trylock_bh") ||
         funcName.equals("_raw_spin_trylock_bh") ||
         funcName.equals("spin_trylock_irq") ||
         funcName.equals("raw_spin_trylock_irq") ||
         funcName.equals("_raw_spin_trylock_irq") ||
         funcName.equals("spin_trylock_irqsave") ||
         funcName.equals("raw_spin_trylock_irqsave") ||
         funcName.equals("_raw_spin_trylock_irqsave");
}
...
inline bool isReadLock(const llvm::StringRef &funcName) {
  return funcName.equals("read_lock") || funcName.equals("read_lock_irq") ||
         funcName.equals("read_lock_irqsave") ||
         funcName.equals("read_lock_bh") || funcName.equals("read_lock_nested");
}

inline bool isReadUnlock(const llvm::StringRef &funcName) {
  return funcName.equals("read_unlock") || funcName.equals("read_unlock_irq") ||
         funcName.equals("read_unlock_irqrestore") ||
         funcName.equals("read_unlock_bh");
}

inline bool isWriteLock(const llvm::StringRef &funcName) {
  return funcName.equals("write_lock") || funcName.equals("write_lock_irq") ||
         funcName.equals("write_lock_irqsave") ||
         funcName.equals("write_lock_bh") ||
         funcName.equals("write_lock_nested");
}

inline bool isWriteUnlock(const llvm::StringRef &funcName) {
  return funcName.equals("write_unlock") ||
         funcName.equals("write_unlock_irq") ||
         funcName.equals("write_unlock_irqrestore") ||
         funcName.equals("write_unlock_bh");
}
...
inline bool isRcuReadLock(const llvm::StringRef &funcName) {
  return funcName.equals("rcu_read_lock") ||
         funcName.equals("__rcu_read_lock") ||
         funcName.equals("rcu_read_lock_bh") ||
         funcName.equals("rcu_read_lock_sched") ||
         funcName.equals("rcu_read_lock_trace") ||
         funcName.equals("srcu_read_lock") ||
         funcName.equals("srcu_read_lock_nmisafe");
}

inline bool isRcuReadUnlock(const llvm::StringRef &funcName) {
  return funcName.equals("rcu_read_unlock") ||
         funcName.equals("__rcu_read_unlock") ||
         funcName.equals("rcu_read_unlock_bh") ||
         funcName.equals("rcu_read_unlock_sched") ||
         funcName.equals("rcu_read_unlock_trace") ||
         funcName.equals("srcu_read_unlock") ||
         funcName.equals("srcu_read_unlock_nmisafe");
}

inline bool isSynchronizeRcu(const llvm::StringRef &funcName) {
  return funcName.equals("synchronize_rcu") ||
         funcName.equals("synchronize_rcu_expedited") ||
         funcName.equals("synchronize_srcu") ||
         funcName.equals("synchronize_rcu_tasks") ||
         funcName.equals("synchronize_rcu_tasks_trace");
}

inline bool isCallRcu(const llvm::StringRef &funcName) {
  return funcName.equals("call_rcu") || funcName.equals("call_srcu") ||
         funcName.equals("call_rcu_tasks") ||
         funcName.equals("call_rcu_tasks_trace") ||
         funcName.equals("kfree_rcu") || funcName.equals("kvfree_rcu");
}

inline bool isRcuDereference(const llvm::StringRef &funcName) {
  return funcName.equals("rcu_dereference") ||
         funcName.equals("rcu_dereference_check") ||
...
inline bool isRcuAssignPointer(const llvm::StringRef &funcName) {
  return funcName.equals("rcu_assign_pointer") ||
         funcName.equals("rcu_replace_pointer");
}
...
inline bool isReadSeqbegin(const llvm::StringRef &funcName) {
  return funcName.equals("read_seqbegin") ||
         funcName.equals("read_seqbegin_irqsave");
}

inline bool isReadSeqretry(const llvm::StringRef &funcName) {
  return funcName.equals("read_seqretry") ||
         funcName.equals("read_seqretry_irqrestore");
}

inline bool isWriteSeqlock(const llvm::StringRef &funcName) {
  return funcName.equals("write_seqlock") ||
         funcName.equals("write_seqlock_irq") ||
         funcName.equals("write_seqlock_irqsave") ||
         funcName.equals("write_seqlock_bh");
}

inline bool isWriteSequnlock(const llvm::StringRef &funcName) {
  return funcName.equals("write_sequnlock") ||
         funcName.equals("write_sequnlock_irq") ||
         funcName.equals("write_sequnlock_irqrestore") ||
         funcName.equals("write_sequnlock_bh");
}
...
inline bool isReinitCompletion(const llvm::StringRef &funcName) {
  return funcName.equals("reinit_completion");
}
...
inline bool isWaitEvent(const llvm::StringRef &funcName) {
  return funcName.equals("wait_event") ||
         funcName.equals("wait_event_interruptible") ||
         funcName.equals("wait_event_killable") ||
         funcName.equals("wait_event_timeout") ||
         funcName.equals("wait_event_interruptible_timeout");
}

inline bool isWakeUp(const llvm::StringRef &funcName) {
  return funcName.equals("wake_up") ||
         funcName.equals("wake_up_interruptible") ||
         funcName.equals("wake_up_nr") || funcName.equals("wake_up_all") ||
         funcName.equals("wake_up_one") || funcName.equals("__wake_up") ||
         funcName.equals("__wake_up_sync_key");
}

inline bool isPrepareToWait(const llvm::StringRef &funcName) {
  return funcName.equals("prepare_to_wait") ||
         funcName.equals("prepare_to_wait_exclusive") ||
         funcName.equals("prepare_to_wait_event");
}
...
inline bool isMemoryBarrier(const llvm::StringRef &funcName) {
  return funcName.equals("mb") || funcName.equals("rmb") ||
         funcName.equals("wmb") || funcName.equals("smp_mb") ||
         funcName.equals("smp_rmb") || funcName.equals("smp_wmb") ||
         funcName.equals("smp_mb__before_atomic") ||
         funcName.equals("smp_mb__after_atomic") || funcName.equals("barrier");
}
...
inline bool isAtomicRead(const llvm::StringRef &funcName) {
  return funcName.startswith("atomic_read") ||
         funcName.startswith("atomic64_read");
}

inline bool isAtomicSet(const llvm::StringRef &funcName) {
  return funcName.startswith("atomic_set") ||
         funcName.startswith("atomic64_set");
}

inline bool isAtomicAdd(const llvm::StringRef &funcName) {
  return funcName.startswith("atomic_add") ||
         funcName.startswith("atomic64_add") ||
         funcName.startswith("atomic_inc") ||
         funcName.startswith("atomic64_inc");
}

inline bool isAtomicSub(const llvm::StringRef &funcName) {
  return funcName.startswith("atomic_sub") ||
         funcName.startswith("atomic64_sub") ||
         funcName.startswith("atomic_dec") ||
         funcName.startswith("atomic64_dec");
}

inline bool isAtomicCmpxchg(const llvm::StringRef &funcName) {
  return funcName.startswith("atomic_cmpxchg") ||
         funcName.startswith("atomic64_cmpxchg") ||
         funcName.startswith("atomic_xchg") ||
         funcName.startswith("atomic64_xchg");
}
...
inline bool isGetCpuVar(const llvm::StringRef &funcName) {
  return funcName.startswith("get_cpu_var") ||
         funcName.startswith("put_cpu_var") ||
         funcName.startswith("this_cpu_ptr") ||
         funcName.startswith("this_cpu_read") ||
...
inline bool isAnyLockAcquire(const llvm::StringRef &funcName) {
  return isSpinLock(funcName) || isMutexLock(funcName) || isDown(funcName) ||
         isDownTryLock(funcName) || isReadLock(funcName) ||
         isWriteLock(funcName) || isDownRead(funcName) ||
...
inline bool isAnyLockRelease(const llvm::StringRef &funcName) {
  return isSpinUnlock(funcName) || isMutexUnlock(funcName) || isUp(funcName) ||
         isReadUnlock(funcName) || isWriteUnlock(funcName) ||
         isUpRead(funcName) || isUpWrite(funcName) ||
         isRcuReadUnlock(funcName) || isWriteSequnlock(funcName);
}
...
inline bool isLinuxKernel(const llvm::StringRef &funcName) {
  return isAnyLockAcquire(funcName) || isAnyLockRelease(funcName) ||
         isSyncPoint(funcName) || isAtomicRead(funcName) ||
         isAtomicSet(funcName) || isAtomicAdd(funcName) ||
         isAtomicSub(funcName) || isAtomicCmpxchg(funcName) ||
         isSetBit(funcName) || isGetCpuVar(funcName) ||
         isInitCompletion(funcName) || isReinitCompletion(funcName) ||
         isComplete(funcName) || isInitWaitqueueHead(funcName) ||
         isWakeUp(funcName) || isPrepareToWait(funcName) ||
         isFinishWait(funcName);
}
