 ...
 * Supports MPI-1, MPI-2 (one-sided), and MPI-3 (non-blocking collectives).
 *
...
inline bool isSendrecv(const llvm::StringRef& funcName) { 
  return funcName.equals("MPI_Sendrecv") || funcName.equals("MPI_Sendrecv_replace"); 
}
...
inline bool isAllgather(const llvm::StringRef& funcName) { 
  return funcName.equals("MPI_Allgather") || funcName.equals("MPI_Allgatherv") || 
         funcName.equals("MPI_Iallgather") || funcName.equals("MPI_Iallgatherv"); 
}
...
inline bool isReduceScatter(const llvm::StringRef& funcName) { 
  return funcName.equals("MPI_Reduce_scatter") || funcName.equals("MPI_Reduce_scatter_block") ||
         funcName.equals("MPI_Ireduce_scatter") || funcName.equals("MPI_Ireduce_scatter_block"); 
}
...
inline bool isWinCreate(const llvm::StringRef& funcName) { 
  return funcName.equals("MPI_Win_create") || funcName.equals("MPI_Win_allocate") || 
         funcName.equals("MPI_Win_create_dynamic") || funcName.equals("MPI_Win_allocate_shared"); 
}
...
inline bool isAccumulate(const llvm::StringRef& funcName) { 
  return funcName.equals("MPI_Accumulate") || funcName.equals("MPI_Raccumulate") ||
         funcName.equals("MPI_Get_accumulate") || funcName.equals("MPI_Rget_accumulate") ||
         funcName.equals("MPI_Fetch_and_op") || funcName.equals("MPI_Compare_and_swap"); 
}
...
inline bool isWinUnlock(const llvm::StringRef& funcName) { 
  return funcName.equals("MPI_Win_unlock") || funcName.equals("MPI_Win_unlock_all"); 
}

inline bool isWinFlush(const llvm::StringRef& funcName) { 
  return funcName.equals("MPI_Win_flush") || funcName.equals("MPI_Win_flush_all") || 
         funcName.equals("MPI_Win_flush_local") || funcName.equals("MPI_Win_flush_local_all"); 
}
...
inline bool isCommDup(const llvm::StringRef& funcName) { 
  return funcName.equals("MPI_Comm_dup") || funcName.equals("MPI_Comm_dup_with_info") ||
         funcName.equals("MPI_Comm_idup"); 
}

inline bool isCommSplit(const llvm::StringRef& funcName) { 
  return funcName.equals("MPI_Comm_split") || funcName.equals("MPI_Comm_split_type"); 
}
...
inline bool isCommCreate(const llvm::StringRef& funcName) { 
  return funcName.equals("MPI_Comm_create") || funcName.equals("MPI_Comm_create_group"); 
}
...
inline bool isCollective(const llvm::StringRef& funcName) {
  return isBarrier(funcName) || isBcast(funcName) || isScatter(funcName) || 
         ...
         isReduce(funcName) || isAllreduce(funcName) || isReduceScatter(funcName) || 
         isScan(funcName);
}
...
inline bool isNonBlocking(const llvm::StringRef& funcName) {
  return isIsend(funcName) || isIrecv(funcName) || isIprobe(funcName) ||
         funcName.startswith("MPI_I") || // Most non-blocking ops start with MPI_I
         funcName.equals("MPI_Rput") || funcName.equals("MPI_Rget") ||
         funcName.equals("MPI_Raccumulate") || funcName.equals("MPI_Rget_accumulate");
}
...
inline bool isRMASync(const llvm::StringRef& funcName) {
  return isWinFence(funcName) || isWinLock(funcName) || isWinUnlock(funcName) ||
         isWinFlush(funcName) || isWinSync(funcName) || 
         isWinPost(funcName) || isWinStart(funcName) || 
         isWinComplete(funcName) || isWinWait(funcName) || isWinTest(funcName);
}

// Check if blocking point-to-point operation
inline bool isBlockingP2P(const llvm::StringRef& funcName) {
  return isSend(funcName) || isRecv(funcName) || isSendrecv(funcName) || isProbe(funcName);
}
