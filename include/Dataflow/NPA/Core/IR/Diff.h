...
private:
  ...
  static E1<TD> aux(const Map &nu, const E0<D> &o) {
    ...
    case K0::Call: {
      ...
      assert(o->t->val.has_value());
      auto right = Exp1<TD>::seqR(Exp1<TD>::hole(o->sym),
    ...
    case K0::Concat: {
      ...
      auto term2 = Exp1<TD>::seqR(Exp1<TD>::hole(o->sym),
                                  Traits::couple(t1_val, t2_val));
    ...
    case K0::Star:
      assert(o->val.has_value());
      return Exp1<TD>::seqR(aux(nu, o->t), Traits::couple(*o->val, *o->val));
    case K0::Mu:
      throw UnsupportedNewtonMuError{};
    }
    return nullptr;
