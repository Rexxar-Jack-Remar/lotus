...
public:
  ...
  struct BinaryValue {
    ...
    bool operator==(const BinaryValue& other) const { return present == other.present; }
  };
  ...
  public:
    ...
    typename IFDSProblem<Fact>::InitialSeeds initial_seeds(const llvm::Module& module) override {
    ...
    normal_edge_function(const llvm::Instruction*, const Fact&, const Fact&) override {
      return this->identity();
    }

    typename IDEProblem<Fact, BinaryValue>::EdgeFunction
    call_edge_function(const llvm::CallBase*, const Fact&, const Fact&) override {
      return this->identity();
    }

    typename IDEProblem<Fact, BinaryValue>::EdgeFunction
    return_edge_function(const llvm::CallBase*, const Fact&, const Fact&) override {
      return this->identity();
    }

    typename IDEProblem<Fact, BinaryValue>::EdgeFunction
    call_to_return_edge_function(const llvm::CallBase*, const Fact&, const Fact&) override {
      return this->identity();
    }
    ...
    BinaryValue join(const BinaryValue& v1, const BinaryValue& v2) const override {
