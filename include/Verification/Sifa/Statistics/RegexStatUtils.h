...
createPEComputer(SifaStats &stats, const lotus::pathexpressions::ILabeledGraph<N, L> &graph);
...
/// Ultimate-aligned: compress DAG with DAG_COMPRESSION_* timing and node counts.
template <typename L>
void compress(SifaStats &stats, RegexDag<L> &dag);

/// Ultimate-aligned: regexToDag(stats, regex) — one-shot: create DAG, add regex, return DAG.
template <typename L>
...
#include "Verification/Sifa/Statistics/RegexStatUtils.tpp"
