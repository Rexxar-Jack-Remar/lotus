 ...
 * @brief Pass for deleting calls to undefined functions and replacing with nondet
 ...
 * @brief Deletes calls to undefined functions and replaces non-void undefined functions with nondet
 *
 * This pass:
 ...
 *
 * Useful for preparing programs with missing function definitions for verification.
 */
