...
template <uint32_t K, uint32_t L> struct KOriginContextEvolveImpl {
  static const KOrigin<K, L> *
  evolve(const KOrigin<K, L> *prevCtx, const llvm::Instruction *I,
...
template <uint32_t K> struct KOriginContextEvolveImpl<K, 0> {
  static const KOrigin<K, 0> *evolve(const KOrigin<K, 0> *,
