...
void NodeFactory::PrintStats(std::ostream &out) {
  std::cout << "Size (free-struct): "
    ...
    << '\n';
  std::cout << "Add (free-struct): " << additions_.size() << '\n';
  std::cout << "Mult (free-struct): " << multiplications_.size() << '\n';
  std::cout << "Stars (free-struct): " << stars_.size() << '\n';
  std::cout << "Elems (free-struct): " << elems_.size() << '\n';
}
