...
public:
    ...
    [[nodiscard]] MemoryKind getKind() const { return Kind; }

    [[nodiscard]] std::vector<AbstractValue *>::iterator begin() { return Mem.begin(); }

    [[nodiscard]] std::vector<AbstractValue *>::iterator end() { return Mem.end(); }
