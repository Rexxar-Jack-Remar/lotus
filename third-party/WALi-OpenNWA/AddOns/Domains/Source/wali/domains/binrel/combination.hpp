...
// From http://www.codeproject.com/Articles/4675/Combinations-in-C
// with only a file name and inclusion guard change.
//
// The licence is the Code Project Open License, currently
// 1.02. http://www.codeproject.com/info/cpol10.aspx. Note that the FSF has
// this to say about this license:
//
//    The Code Project Open License is not a free software license. Section
//    5.6 restricts how you can use the work. Section 5.4 prohibits
//    commercial distribution of the software by itself—and depending on how
//    you read section 3.4, you may not have permission to distribute the
//    software by itself at all.
//
// I plan to replace this code in the future.   -EED



#ifndef WALI_DOMAINS_BINREL_COMBINATION_HPP
#define WALI_DOMAINS_BINREL_COMBINATION_HPP
